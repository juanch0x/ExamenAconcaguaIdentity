        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Solicitantes_Dni", x => x.Dni);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdSolicitante = table.Column<long>(nullable: false),
                    SolicitanteId = table.Column<long>(nullable: true),
                    MontoSolicitado = table.Column<decimal>(nullable: false),
                    AutorizacionDelPrestamo = table.Column<DateTime>(nullable: true),
                    FechaTentativaDeEntrega = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FechaPago = table.Column<DateTimeOffset>(nullable: false),
                    Pagado = table.Column<bool>(nullable: false),
                    TotalCuota = table.Column<decimal>(nullable: false),
                    PrestamoId = table.Column<int>(nullable: false),
                    PrestamoId1 = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
